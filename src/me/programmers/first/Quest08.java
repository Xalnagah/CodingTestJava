...
public class Quest08 {
    public static String solution(int[] numbers, String mainHand) {
...
class HandStatus {
    ...
    public void reloadPosition() {
        ...
        if (this.selectNumber == 1 || this.selectNumber == 4 || this.selectNumber == 7) {
            ...
            int rightCnt = getMoveCount(rightPosition, this.rightPosition);
    ...
    public int getMoveCount(int start, int end) {
        ...
        if (moveNum == end)
            ...
            return Math.abs(moveCnt + (end - moveNum));
    }
}
